                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          AlbumCard(
                            label: "Top Indie",
                            image: AssetImage("assets/peewee.jpg"),
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Motivasion Music",
                            image: AssetImage("assets/top-musik-indo.png"),
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Jazz & Rnb",
                          ...
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Top songs Indonesia",
                            image: AssetImage("assets/album6.jpg"),
                          ),
                          SizedBox(width: 16),
                          AlbumCard(
                            label: "Top songs US",
                            image: AssetImage("assets/Maroon-5-overexposed.jpg"),
                          ),
                        ],
                      ),
                    ),
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 16),
                              SongCard(
                                image: AssetImage("assets/music-album-06.jpg"),
                              ),
                              SizedBox(width: 16),
                              SongCard(
                                image: AssetImage("assets/album9.jpg"),
